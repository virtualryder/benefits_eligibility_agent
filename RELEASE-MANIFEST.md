...
- **512 offline tests** — the CI suite (control-plane + 45 CDK synthesis + 3 doc-integrity gates + 4 independent-verification gates + 3 CI-completeness gates + the doc-count gate). Authoritative offline number. Locally you see `298 passed, 1 skipped`: one gate asserts the CDK libs are installed and only runs inside CI.
