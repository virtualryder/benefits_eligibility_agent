...
| **Offline test suite** | **91 / 91** passing (control-plane + **13 CDK stack-synthesis** assertions) |
...
- **91 offline tests** — the CI suite (control-plane + 13 CDK synthesis). Authoritative offline number.
