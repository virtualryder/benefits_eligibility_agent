...
| Claim | Status |
|---|---|
| Offline suite | **200 passing** (124 locally + 1 CI-only gate) (control-plane + 16 CDK stack-synthesis assertions) — authoritative count: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md) |
...
| Live governance demo (shell engine, legacy) | 29 checks against a deployed system in Cedar ENFORCE — a **separate** artifact from the 200 offline tests |
...
Suite: **200 offline tests** (the older `v0.1.2-pilot-rc1` tag predates the dependency migration and
