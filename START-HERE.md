...
| Claim | Status |
|---|---|
| Offline suite | **285 tests** (all pass locally except one CI-only gate that is skipped offline) (control-plane + 37 CDK stack-synthesis assertions) — authoritative count: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md) |
...
| Live governance demo (shell engine, legacy) | 29 checks against a deployed system in Cedar ENFORCE — a **separate** artifact from the 285 offline tests |
