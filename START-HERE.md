...
| Claim | Status |
|---|---|
| Offline suite | **137 passing** (124 locally + 1 CI-only gate) (control-plane + 14 CDK stack-synthesis assertions) — authoritative count: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md) |
...
| Live governance demo (shell engine, legacy) | 29 checks against a deployed system in Cedar ENFORCE — a **separate** artifact from the 137 offline tests |
...
tag `v0.2.0-pilot-rc1`, cut from this tree. Suite: **137 offline tests** (the older `v0.1.2-pilot-rc1` tag predates the dependency migration and stood at 101; do not
