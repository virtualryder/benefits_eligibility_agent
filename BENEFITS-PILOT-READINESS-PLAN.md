...
EP1-validated**; **244 offline tests** on current main (control-plane + 25 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 244/244 offline (CI); CDK synthesizes to valid CloudFormation.
