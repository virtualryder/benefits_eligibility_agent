...
EP1-validated**; **200 offline tests** on current main (control-plane + 18 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 200/200 offline (CI); CDK synthesizes to valid CloudFormation.
