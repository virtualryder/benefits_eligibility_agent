...
EP1-validated**; **135 offline tests** on current main (control-plane + 14 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 135/135 offline (CI); CDK synthesizes to valid CloudFormation.
