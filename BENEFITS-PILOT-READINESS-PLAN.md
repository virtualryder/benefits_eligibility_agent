...
EP1-validated**; **512 offline tests** on current main (control-plane + 45 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 255/244 offline (CI); CDK synthesizes to valid CloudFormation.
