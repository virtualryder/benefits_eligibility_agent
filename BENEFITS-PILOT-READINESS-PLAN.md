...
EP1-validated**; **237 offline tests** on current main (control-plane + 25 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 237/237 offline (CI); CDK synthesizes to valid CloudFormation.
