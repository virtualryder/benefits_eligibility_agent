...
EP1-validated**; **168 offline tests** on current main (control-plane + 17 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 168/168 offline (CI); CDK synthesizes to valid CloudFormation.
