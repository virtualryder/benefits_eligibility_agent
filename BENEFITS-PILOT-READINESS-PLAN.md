...
EP1-validated**; **125 offline tests** on current main (control-plane + 13 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 125/125 offline (CI); CDK synthesizes to valid CloudFormation.
