...
EP1-validated**; **147 offline tests** on current main (control-plane + 16 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 147/147 offline (CI); CDK synthesizes to valid CloudFormation.
