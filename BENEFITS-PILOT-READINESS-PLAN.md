...
EP1-validated**; **143 offline tests** on current main (control-plane + 15 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 143/143 offline (CI); CDK synthesizes to valid CloudFormation.
