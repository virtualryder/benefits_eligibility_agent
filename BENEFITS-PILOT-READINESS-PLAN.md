...
EP1-validated**; **180 offline tests** on current main (control-plane + 18 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 180/180 offline (CI); CDK synthesizes to valid CloudFormation.
