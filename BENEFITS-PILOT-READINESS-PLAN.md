...
EP1-validated**; **137 offline tests** on current main (control-plane + 14 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 137/137 offline (CI); CDK synthesizes to valid CloudFormation.
