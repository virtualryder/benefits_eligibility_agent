...
EP1-validated**; **234 offline tests** on current main (control-plane + 25 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 234/234 offline (CI); CDK synthesizes to valid CloudFormation.
