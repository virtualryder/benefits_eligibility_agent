...
EP1-validated**; **230 offline tests** on current main (control-plane + 21 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 230/230 offline (CI); CDK synthesizes to valid CloudFormation.
