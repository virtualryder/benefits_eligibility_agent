...
EP1-validated**; **142 offline tests** on current main (control-plane + 14 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 142/142 offline (CI); CDK synthesizes to valid CloudFormation.
