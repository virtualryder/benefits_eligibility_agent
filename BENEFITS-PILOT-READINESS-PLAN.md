...
EP1-validated**; **233 offline tests** on current main (control-plane + 24 CDK synthesis). **Owner:** David Ryder (AWS SA).
...
**Gate A — code + synth (done).** 233/233 offline (CI); CDK synthesizes to valid CloudFormation.
