...
def main():
    ...
    _wr(_t("_m.json"), {"case": "Applicant Probe Person, SSN 123-45-6789, 5 Main St. Household size 3. Monthly income $1200. Liquid resources $50."})
    ...
    mask = _rd(_t("_mo.json")) if rc == 0 else {}
    ...
    for name, ref, want in (("guard_genuine", mask.get("sanitized_ref"), True),
        ...
        _wr(_t("_g.json"), {"guard": "deidentified", "sanitized_ref": ref})
        ...
        g = _rd(_t("_go.json")) if rc == 0 else {}
    ...
    ing = _rd(_t("_io.json")) if rc == 0 else {}
    ...
    _wr(_t("_w.json"), {"case_id": ing.get("case_id", "VAL"), "requester": "validator",
