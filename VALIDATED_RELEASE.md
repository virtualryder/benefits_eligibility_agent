...
| Test count at the tag | **230** offline tests (229 local + 1 CI-only); 21 CDK assertions |
...
| Test count on current main | **230 offline tests** (control-plane + CDK synthesis + governance gates + the doc-count gate). Authoritative matrix: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md). |
