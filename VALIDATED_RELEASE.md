...
| Test count at the tag | **244** offline tests (243 local + 1 CI-only); 31 CDK assertions |
...
| Test count on current main | **263 offline tests** (control-plane + CDK synthesis + governance gates + the doc-count gate). Authoritative matrix: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md). |
