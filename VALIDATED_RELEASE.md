...
| Test count at the tag | **180** offline tests (179 local + 1 CI-only); 18 CDK assertions |
...
| Test count on current main | **180 offline tests** (control-plane + CDK synthesis + governance gates + the doc-count gate). Authoritative matrix: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md). |
