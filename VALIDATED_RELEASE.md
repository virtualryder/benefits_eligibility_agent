...
| Test count at the tag | **234** offline tests (233 local + 1 CI-only); 25 CDK assertions |
...
| Test count on current main | **234 offline tests** (control-plane + CDK synthesis + governance gates + the doc-count gate). Authoritative matrix: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md). |
