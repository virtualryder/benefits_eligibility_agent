...
| Test count at the tag | **233** offline tests (232 local + 1 CI-only); 24 CDK assertions |
...
| Test count on current main | **233 offline tests** (control-plane + CDK synthesis + governance gates + the doc-count gate). Authoritative matrix: [`RELEASE-MANIFEST.md`](RELEASE-MANIFEST.md). |
