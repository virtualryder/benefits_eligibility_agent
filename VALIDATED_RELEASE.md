...
| Per-tenant token + USD budget (after this tag, on main) | **PASS (2026-09-03, env `mt6`, 23/23)** — governed-core 1.9.0; `evidence/AGENTCORE-BUDGET-2026-09-03.md`. Not part of `v0.3.0-pilot-rc1`; the next tag will carry it. |
