...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **137 offline tests**
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 137 tests**
