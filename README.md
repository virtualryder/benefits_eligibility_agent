...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **304 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 304 tests**
...
python -m pytest -q                  # 304 collected on Python 3.12
```
