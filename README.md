...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **390 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 390 tests**
...
python -m pytest -q                  # 390 collected on Python 3.12
```
