...
> release tag [`v0.6.0-pilot-rc1`](https://github.com/virtualryder/benefits_eligibility_agent/releases/tag/v0.6.0-pilot-rc1)**
...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **445 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 445 tests**
...
python -m pytest -q                  # 445 collected on Python 3.12
```
