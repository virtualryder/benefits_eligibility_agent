...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Suite: **101 offline tests**.
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 101 tests**
