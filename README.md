...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **284 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 284 tests**
> (control-plane + 36 CDK synthesis) — the authoritative CI number (`RELEASE-MANIFEST.md`).
