...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **135 offline tests**
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 135 tests**
> (control-plane + 14 CDK synthesis) — the authoritative CI number (`RELEASE-MANIFEST.md`).
