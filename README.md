...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 285 tests**
> (control-plane + 37 CDK synthesis) — the authoritative CI number (`RELEASE-MANIFEST.md`).
