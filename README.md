...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **396 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 396 tests**
...
python -m pytest -q                  # 396 collected on Python 3.12
```
