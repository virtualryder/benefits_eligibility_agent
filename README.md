...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **292 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 292 tests**
> (control-plane + 38 CDK synthesis) — the authoritative CI number (`RELEASE-MANIFEST.md`).
...
python -m pytest -q                  # 292 collected on Python 3.12
```
