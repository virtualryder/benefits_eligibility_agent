...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **385 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 385 tests**
...
python -m pytest -q                  # 385 collected on Python 3.12
```
