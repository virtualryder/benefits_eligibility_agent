...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **233 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 233 tests**
> (control-plane + 24 CDK synthesis) — the authoritative CI number (`RELEASE-MANIFEST.md`).
