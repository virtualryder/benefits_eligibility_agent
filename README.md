...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.2-pilot-rc1`. Current suite: **283 offline tests**;
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 283 tests**
