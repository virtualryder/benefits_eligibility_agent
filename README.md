...
> Evidence: `evidence/EP1-VALIDATION.md`; tag `v0.1.0-pilot-rc1`. Suite: **98 offline tests**.
...
> **Two distinct artifacts — do not conflate them.** (1) The **offline suite: 98/98 tests**
