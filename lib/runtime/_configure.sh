...
# EXECUTION ROLE AS IaC (third external review, 2026-09-05): never let the toolkit auto-create the role
# (AWS: CLI-generated policies are for development/testing). The compute stack exports the least-privilege
# role; resolve it from the stack output (or RUNTIME_ROLE_ARN in the environment) and REFUSE without it.
