...
def _exactly_once_marker(case_id, submission_id, approver, region):
    ...
    Ported from edu_financial_aid_agent 2026-08-03, where it had existed since GA-5 and never reached
    this repo. For a benefits determination the absence means a retried or replayed finalize can commit
    the same adverse action twice — a due-process problem, not just a duplicate record."""
    import boto3
