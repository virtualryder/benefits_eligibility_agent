...
*Reviewable, parameterized IaC. Deploy the validated release tag (`v0.5.2-pilot-rc1`), never `main`, per
...
```
git checkout v0.5.2-pilot-rc1            # deploy the validated release, never main
