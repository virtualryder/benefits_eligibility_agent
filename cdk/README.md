...
*Reviewable, parameterized IaC. Deploy the validated release tag (`v0.6.0-pilot-rc1`), never `main`, per
...
```
git checkout v0.6.0-pilot-rc1            # deploy the validated release, never main
