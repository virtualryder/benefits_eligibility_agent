"""Third external review (2026-09-05): the AgentCore runtime entrypoint accepted an unvalidated `prompt`
...
def test_plain_prompt_and_ids_accepted():
    prompt, case_id, requester = agent.validate_input({"prompt": "  Screen case BEN-1  ", "case_id": "BEN-1", "requester": "alice@agency"})
    assert prompt == "Screen case BEN-1" and case_id == "BEN-1" and requester == "alice@agency"
