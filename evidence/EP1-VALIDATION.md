...
by the offline suite — **98/98 passing at the time of this run** (control-plane + 16 CDK synthesis).
The suite has grown since: it is **147 tests** today, after post-run hardening and doc-integrity gates
