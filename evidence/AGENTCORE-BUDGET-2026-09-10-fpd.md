...
Env `ben-fpd` · us-east-1 · meter table `ben-fpd-budgets` · tenants ['sp-a', 'sp-b'] · 314.1 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 63937 / tokens_out 2898 / calls 13 / usd_micro 235281 (= $0.235281 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16571, tokens_out 688.
- Run 2 (tenant A, cap 71835 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72166 = 100.5 % of cap; alarms {'ben-fpd-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fpd-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpd-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
