...
Env `ben-fp6` · us-east-1 · meter table `ben-fp6-budgets` · tenants ['sp-a', 'sp-b'] · 366.6 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 63727 / tokens_out 2884 / calls 13 / usd_micro 234441 (= $0.234441 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16562, tokens_out 730.
- Run 2 (tenant A, cap 71611 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72093 = 100.7 % of cap; alarms {'ben-fp6-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fp6-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp6-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
