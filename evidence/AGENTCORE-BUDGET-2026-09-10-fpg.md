...
Env `ben-fpg` · us-east-1 · meter table `ben-fpg-budgets` · tenants ['sp-a', 'sp-b'] · 372.8 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 58007 / tokens_out 2960 / calls 12 / usd_micro 218421 (= $0.218421 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 2, tokens_in 10817, tokens_out 719.
- Run 2 (tenant A, cap 65967 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 66453 = 100.7 % of cap; alarms {'ben-fpg-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fpg-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpg-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
