...
Env `ben-fp2` · us-east-1 · meter table `ben-fp2-budgets` · tenants ['sp-a', 'sp-b'] · 372.2 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 63861 / tokens_out 2933 / calls 13 / usd_micro 235578 (= $0.235578 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16548, tokens_out 674.
- Run 2 (tenant A, cap 71794 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72276 = 100.7 % of cap; alarms {'ben-fp2-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fp2-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp2-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
