...
Env `ben-fp7` · us-east-1 · meter table `ben-fp7-budgets` · tenants ['sp-a', 'sp-b'] · 359.5 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 63815 / tokens_out 2930 / calls 13 / usd_micro 235395 (= $0.235395 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16533, tokens_out 743.
- Run 2 (tenant A, cap 71745 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72071 = 100.5 % of cap; alarms {'ben-fp7-budget-sp-a-TokensUsedPct-100': 'OK', 'ben-fp7-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp7-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
