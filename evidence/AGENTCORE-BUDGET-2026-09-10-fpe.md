...
Env `ben-fpe` · us-east-1 · meter table `ben-fpe-budgets` · tenants ['sp-a', 'sp-b'] · 346.8 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 52839 / tokens_out 2657 / calls 11 / usd_micro 198372 (= $0.198372 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 2, tokens_in 10663, tokens_out 401.
- Run 2 (tenant A, cap 60496 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 60975 = 100.8 % of cap; alarms {'ben-fpe-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fpe-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpe-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
