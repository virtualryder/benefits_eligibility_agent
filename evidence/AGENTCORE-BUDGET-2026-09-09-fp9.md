...
Env `ben-fp9` · us-east-1 · meter table `ben-fp9-budgets` · tenants ['sp-a', 'sp-b'] · 391.8 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 64163 / tokens_out 3137 / calls 13 / usd_micro 239544 (= $0.239544 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16976, tokens_out 978.
- Run 2 (tenant A, cap 72300 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72633 = 100.5 % of cap; alarms {'ben-fp9-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fp9-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp9-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
