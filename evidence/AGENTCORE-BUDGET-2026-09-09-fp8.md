...
Env `ben-fp8` · us-east-1 · meter table `ben-fp8-budgets` · tenants ['sp-a', 'sp-b'] · 318.6 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 64210 / tokens_out 3229 / calls 13 / usd_micro 241065 (= $0.241065 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 17007, tokens_out 1029.
- Run 2 (tenant A, cap 72439 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 72918 = 100.7 % of cap; alarms {'ben-fp8-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fp8-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp8-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
