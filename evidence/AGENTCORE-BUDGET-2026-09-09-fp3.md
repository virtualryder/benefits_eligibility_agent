...
Env `ben-fp3` · us-east-1 · meter table `ben-fp3-budgets` · tenants ['sp-a', 'sp-b'] · 326.9 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 50369 / tokens_out 2879 / calls 11 / usd_micro 194292 (= $0.194292 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16526, tokens_out 710.
- Run 2 (tenant A, cap 58248 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 58644 = 100.7 % of cap; alarms {'ben-fp3-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fp3-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp3-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
