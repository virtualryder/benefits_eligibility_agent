...
Env `ben-fpa` · us-east-1 · meter table `ben-fpa-budgets` · tenants ['sp-a', 'sp-b'] · 332.0 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 83455 / tokens_out 3921 / calls 16 / usd_micro 309180 (= $0.309180 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 6, tokens_in 36211, tokens_out 1720.
- Run 2 (tenant A, cap 92376 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 92704 = 100.4 % of cap; alarms {'ben-fpa-budget-sp-a-TokensUsedPct-100': 'OK', 'ben-fpa-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpa-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
