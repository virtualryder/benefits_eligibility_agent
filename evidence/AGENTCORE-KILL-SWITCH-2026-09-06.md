...
Env `ben-fp` · us-east-1 · parameter `/ben-fp-eligibility/kill-switch` · tenants ['sp-a', 'sp-b'] · 119.7 s · **PASS** · time-to-effect at the gateway: **16.0 s**
...
- Gateway after engage: tools/list 403 / tools/call 403 — `containment engaged (kill switch /ben-fp-eligibility/kill-switch): every agent action is refused` (time-to-effect 16.0 s)
...
- **Base ledger `KILL-SWITCH` chain** (platform scope): seq 0 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-responder/ks-a`; seq 1 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`; seq 2 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 3 kill_switch.disengage DENIED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 4 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`; seq 5 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-observability-BudgetBreachServiceRole183A354-IYF9qSLxOFzL/ben-fp-budget-breach`; seq 6 kill_switch.disengage COMMITTED by `arn:aws:iam::111122223333:user/dryder`; seq 7 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-responder/ks-a`; seq 8 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`; seq 9 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 10 kill_switch.disengage DENIED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 11 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`; seq 12 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-observability-BudgetBreachServiceRole183A354-IYF9qSLxOFzL/ben-fp-budget-breach`; seq 13 kill_switch.disengage COMMITTED by `arn:aws:iam::111122223333:user/dryder`; seq 14 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-responder/ks-a`; seq 15 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`; seq 16 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 17 kill_switch.disengage DENIED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-overprivileged/ks-c`; seq 18 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp-ks-security-lead/ks-b`
- Tenant-A denials (DENIED `kill_switch.deny`): 8; WORM copies: 8; tenant-B rows in its own ledger: 6
