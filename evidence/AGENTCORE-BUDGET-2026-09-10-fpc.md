...
Env `ben-fpc` · us-east-1 · meter table `ben-fpc-budgets` · tenants ['sp-a', 'sp-b'] · 317.1 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 55796 / tokens_out 2851 / calls 12 / usd_micro 210153 (= $0.210153 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16550, tokens_out 672.
- Run 2 (tenant A, cap 63647 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 63983 = 100.5 % of cap; alarms {'ben-fpc-budget-sp-a-TokensUsedPct-100': 'OK', 'ben-fpc-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpc-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
