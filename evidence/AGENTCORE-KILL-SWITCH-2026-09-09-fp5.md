...
Env `ben-fp5` · us-east-1 · parameter `/ben-fp5-eligibility/kill-switch` · tenants ['sp-a', 'sp-b'] · 107.6 s · **PASS** · time-to-effect at the gateway: **15.4 s**
...
- Gateway after engage: tools/list 403 / tools/call 403 — `containment engaged (kill switch /ben-fp5-eligibility/kill-switch): every agent action is refused` (time-to-effect 15.4 s)
- Direct tool invoke: {'FunctionError': 'Unhandled', 'errorType': 'KillSwitchEngaged', 'errorMessage': 'kill switch ENGAGED (/ben-fp5-eligibility/kill-switch): SEV-1 drill: runaway agent suspected'}; Step Functions: {'status': 'FAILED', 'error': 'KillSwitchEngaged', 'states_entered': ['Extract']}
...
- **Base ledger `KILL-SWITCH` chain** (platform scope): seq 0 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp5-ks-responder/ks-a`; seq 1 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp5-ks-security-lead/ks-b`; seq 2 kill_switch.engage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp5-ks-overprivileged/ks-c`; seq 3 kill_switch.disengage DENIED by `arn:aws:sts::111122223333:assumed-role/ben-fp5-ks-overprivileged/ks-c`; seq 4 kill_switch.disengage COMMITTED by `arn:aws:sts::111122223333:assumed-role/ben-fp5-ks-security-lead/ks-b`
- Tenant-A denials (DENIED `kill_switch.deny`): 2; WORM copies: 2; tenant-B rows in its own ledger: 2

Roles (throwaway, deleted): {'A': 'arn:aws:iam::111122223333:role/ben-fp5-ks-responder', 'B': 'arn:aws:iam::111122223333:role/ben-fp5-ks-security-lead', 'C': 'arn:aws:iam::111122223333:role/ben-fp5-ks-overprivileged'} → cleanup {'A': 'deleted', 'B': 'deleted', 'C': 'deleted'}
