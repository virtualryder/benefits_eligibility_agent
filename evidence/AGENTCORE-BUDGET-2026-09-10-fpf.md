...
Env `ben-fpf` · us-east-1 · meter table `ben-fpf-budgets` · tenants ['sp-a', 'sp-b'] · 320.2 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 57907 / tokens_out 2605 / calls 12 / usd_micro 212796 (= $0.212796 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 2, tokens_in 10667, tokens_out 417.
- Run 2 (tenant A, cap 65512 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 65875 = 100.6 % of cap; alarms {'ben-fpf-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fpf-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpf-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
