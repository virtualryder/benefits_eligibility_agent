...
Env `ben-fp4` · us-east-1 · meter table `ben-fp4-budgets` · tenants ['sp-a', 'sp-b'] · 313.8 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 57878 / tokens_out 2859 / calls 12 / usd_micro 216519 (= $0.216519 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 2, tokens_in 10739, tokens_out 585.
- Run 2 (tenant A, cap 65737 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 66220 = 100.7 % of cap; alarms {'ben-fp4-budget-sp-a-TokensUsedPct-100': 'OK', 'ben-fp4-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fp4-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
