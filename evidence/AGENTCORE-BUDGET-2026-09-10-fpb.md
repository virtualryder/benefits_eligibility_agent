...
Env `ben-fpb` · us-east-1 · meter table `ben-fpb-budgets` · tenants ['sp-a', 'sp-b'] · 367.3 s · **PASS**
...
- Run 1 (tenant A, uncapped): meter tokens_in 63630 / tokens_out 2884 / calls 13 / usd_micro 234150 (= $0.234150 at price_version `benefits-2026-09-03-anthropic-platform-UNCONFIRMED-ON-BEDROCK`); model-invocation log for the same session: rows 3, tokens_in 16542, tokens_out 676.
- Run 2 (tenant A, cap 71514 = 1.5 x run 1): stopped mid-session with guardrail_action BUDGET; meter used 71851 = 100.5 % of cap; alarms {'ben-fpb-budget-sp-a-TokensUsedPct-100': 'ALARM', 'ben-fpb-budget-sp-a-TokensUsedPct-60': 'ALARM', 'ben-fpb-budget-sp-a-TokensUsedPct-85': 'ALARM'}.
