...
git checkout v0.1.0-pilot-rc1          # the tag, never main — the harness enforces this
...
|---|---|---|
| `preflight.on_release_tag` | you are on `v0.1.0-pilot-rc1` with a clean tree | you verified the *released* artifact, not a working copy |
